 ...
 * C file create date: Sat  9 Mar 2013 16:20:26 GMT
 */
...
void usage(void) {
	...
	printf(" * XML source: Q77_qstroke_19_0.xml\n");
	printf(" * STATA dta time stamp: 9 Mar 2013 15:23\n");
	printf(" * C file create date: Sat  9 Mar 2013 16:20:26 GMT\n");
	printf(" *\n");
	printf("Usage:\n");
	printf("  Q77_qstroke_19_0_commandLine age b_AF b_CCF b_chd b_ra b_renal b_treatedhyp b_type1 b_type2 b_valvular bmi ethrisk fh_cvd rati sbp smoke_cat surv town\n");
}
...
int main (int argc, char *argv[]) {
	...
	double score = stroke_female(age,b_AF,b_CCF,b_chd,b_ra,b_renal,b_treatedhyp,b_type1,b_type2,b_valvular,bmi,ethrisk,fh_cvd,rati,sbp,smoke_cat,surv,town,&error,errorBuf,sizeof(errorBuf));
	if (error) {
		printf("%s", errorBuf);
		exit(1);
	}
