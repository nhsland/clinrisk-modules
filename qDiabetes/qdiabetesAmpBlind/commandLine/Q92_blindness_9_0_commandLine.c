 ...
 * C file create date: Mon  9 Nov 2015 09:52:33 GMT
 */
...
void usage(void) {
	...
	printf(" * XML source: Q92_blindness_9_0.xml\n");
	printf(" * STATA dta time stamp: 16 Jan 2015 13:01\n");
	printf(" * C file create date: Mon  9 Nov 2015 09:52:33 GMT\n");
	printf(" *\n");
	printf("Usage:\n");
	printf("  Q92_blindness_9_0_commandLine age b_prolif_maculo b_renal b_type1 diabetes_years2 hba1c rati sbp surv town\n");
}
...
int main (int argc, char *argv[]) {
	...
	double score = blindness_female(age,b_prolif_maculo,b_renal,b_type1,diabetes_years2,hba1c,rati,sbp,surv,town,&error,errorBuf,sizeof(errorBuf));
	if (error) {
		printf("%s", errorBuf);
		exit(1);
	}
