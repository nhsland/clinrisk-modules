Welcome to cholRatioPredictor (http://svn.clinrisk.co.uk/opensource/cholRatioPredictor)
-------------------------------------------
...
To compile cholRatioPredictor on a UNIX-like system, type
 make
 make executables
to create the command line executables.

Please check http://svn.clinrisk.co.uk/opensource/cholRatioPredictor for our latest sources.
The cholRatioPredictor algorithms will be updated annually.  

This is the initial 2010 open source release, and has STATA dta time stamp: 2 Sep 2009 08:55
