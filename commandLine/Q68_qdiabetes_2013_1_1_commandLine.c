...
#include <stdio.h>
#include <stdlib.h>
#include <clinrisk/Q68_qdiabetes_2013_1_1.h>
...
int main (int argc, char *argv[]) {
	...
	double score = type2_male(age,b_corticosteroids,b_cvd,b_treatedhyp,bmi,ethrisk,fh_diab,smoke_cat,surv,town,&error,errorBuf,sizeof(errorBuf));
	if (error) {
		printf("%s", errorBuf);
		exit(1);
	}
