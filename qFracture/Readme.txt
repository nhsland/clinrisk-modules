Welcome to QFracture-2012 (http://qfracture.org)
--
...
To compile QFracture-2012 on a UNIX-like system, type
 make
to create the command line executables.

Please check http://svn.clinrisk.co.uk/qfracture for the latest sources.
We expect to update the QFracture-2012 algorithm(s) annually.  
