...
#include <math.h>
#include <string.h>
#include "Q76_cancer2_16_0.h"
#include "utils.h"

/* blood_cancer */

static double blood_cancer_female_raw(
int age,double bmi,int c_hb,int new_abdopain,int new_haematuria,int new_necklump,int new_nightsweats,int new_pmb,int new_vte,int new_weightloss,int s1_bowelchange,int s1_bruising
)
{
	double survivor[0] = {
...
int age,double bmi,int c_hb,int new_abdopain,int new_haematuria,int new_necklump,int new_nightsweats,int new_pmb,int new_vte,int new_weightloss,int s1_bowelchange,int s1_bruising,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = blood_cancer_female_validation(age,bmi,c_hb,new_abdopain,new_haematuria,new_necklump,new_nightsweats,new_pmb,new_vte,new_weightloss,s1_bowelchange,s1_bruising,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double breast_cancer_female_raw(
int age,int alcohol_cat4,double bmi,int fh_breastcancer,int new_breastlump,int new_breastpain,int new_breastskin,int new_pmb,int new_vte,double town
)
{
	double survivor[0] = {
...
int age,int alcohol_cat4,double bmi,int fh_breastcancer,int new_breastlump,int new_breastpain,int new_breastskin,int new_pmb,int new_vte,double town,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = breast_cancer_female_validation(age,alcohol_cat4,bmi,fh_breastcancer,new_breastlump,new_breastpain,new_breastskin,new_pmb,new_vte,town,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double cervical_cancer_female_raw(
int age,double bmi,int c_hb,int new_abdopain,int new_haematuria,int new_imb,int new_pmb,int new_postcoital,int new_vte,int smoke_cat,double town
)
{
	double survivor[0] = {
...
int age,double bmi,int c_hb,int new_abdopain,int new_haematuria,int new_imb,int new_pmb,int new_postcoital,int new_vte,int smoke_cat,double town,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = cervical_cancer_female_validation(age,bmi,c_hb,new_abdopain,new_haematuria,new_imb,new_pmb,new_postcoital,new_vte,smoke_cat,town,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double colorectal_cancer_female_raw(
int age,int alcohol_cat4,double bmi,int c_hb,int fh_gicancer,int new_abdodist,int new_abdopain,int new_appetiteloss,int new_rectalbleed,int new_vte,int new_weightloss,int s1_bowelchange,int s1_constipation
)
{
	double survivor[0] = {
...
int age,int alcohol_cat4,double bmi,int c_hb,int fh_gicancer,int new_abdodist,int new_abdopain,int new_appetiteloss,int new_rectalbleed,int new_vte,int new_weightloss,int s1_bowelchange,int s1_constipation,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = colorectal_cancer_female_validation(age,alcohol_cat4,bmi,c_hb,fh_gicancer,new_abdodist,new_abdopain,new_appetiteloss,new_rectalbleed,new_vte,new_weightloss,s1_bowelchange,s1_constipation,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double gastro_oesophageal_cancer_female_raw(
int age,double bmi,int c_hb,int new_abdopain,int new_appetiteloss,int new_dysphagia,int new_gibleed,int new_heartburn,int new_indigestion,int new_vte,int new_weightloss,int smoke_cat
)
{
	double survivor[0] = {
...
int age,double bmi,int c_hb,int new_abdopain,int new_appetiteloss,int new_dysphagia,int new_gibleed,int new_heartburn,int new_indigestion,int new_vte,int new_weightloss,int smoke_cat,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = gastro_oesophageal_cancer_female_validation(age,bmi,c_hb,new_abdopain,new_appetiteloss,new_dysphagia,new_gibleed,new_heartburn,new_indigestion,new_vte,new_weightloss,smoke_cat,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double lung_cancer_female_raw(
int age,int b_copd,double bmi,int c_hb,int new_appetiteloss,int new_dysphagia,int new_haemoptysis,int new_indigestion,int new_necklump,int new_vte,int new_weightloss,int s1_cough,int smoke_cat,double town
)
{
	double survivor[0] = {
...
int age,int b_copd,double bmi,int c_hb,int new_appetiteloss,int new_dysphagia,int new_haemoptysis,int new_indigestion,int new_necklump,int new_vte,int new_weightloss,int s1_cough,int smoke_cat,double town,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = lung_cancer_female_validation(age,b_copd,bmi,c_hb,new_appetiteloss,new_dysphagia,new_haemoptysis,new_indigestion,new_necklump,new_vte,new_weightloss,s1_cough,smoke_cat,town,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double other_cancer_female_raw(
int age,int alcohol_cat4,int b_copd,double bmi,int c_hb,int new_abdodist,int new_abdopain,int new_appetiteloss,int new_breastlump,int new_dysphagia,int new_gibleed,int new_haematuria,int new_indigestion,int new_necklump,int new_pmb,int new_vte,int new_weightloss,int s1_constipation,int smoke_cat
)
{
	double survivor[0] = {
...
{
	*error = 0;	int ok = other_cancer_female_validation(age,alcohol_cat4,b_copd,bmi,c_hb,new_abdodist,new_abdopain,new_appetiteloss,new_breastlump,new_dysphagia,new_gibleed,new_haematuria,new_indigestion,new_necklump,new_pmb,new_vte,new_weightloss,s1_constipation,smoke_cat,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double ovarian_cancer_female_raw(
int age,double bmi,int c_hb,int fh_ovariancancer,int new_abdodist,int new_abdopain,int new_appetiteloss,int new_haematuria,int new_indigestion,int new_pmb,int new_vte,int new_weightloss,int s1_bowelchange
)
{
	double survivor[0] = {
...
int age,double bmi,int c_hb,int fh_ovariancancer,int new_abdodist,int new_abdopain,int new_appetiteloss,int new_haematuria,int new_indigestion,int new_pmb,int new_vte,int new_weightloss,int s1_bowelchange,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = ovarian_cancer_female_validation(age,bmi,c_hb,fh_ovariancancer,new_abdodist,new_abdopain,new_appetiteloss,new_haematuria,new_indigestion,new_pmb,new_vte,new_weightloss,s1_bowelchange,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double pancreatic_cancer_female_raw(
int age,int b_chronicpan,int b_type2,double bmi,int new_abdopain,int new_appetiteloss,int new_dysphagia,int new_gibleed,int new_indigestion,int new_vte,int new_weightloss,int s1_bowelchange,int smoke_cat
)
{
	double survivor[0] = {
...
int age,int b_chronicpan,int b_type2,double bmi,int new_abdopain,int new_appetiteloss,int new_dysphagia,int new_gibleed,int new_indigestion,int new_vte,int new_weightloss,int s1_bowelchange,int smoke_cat,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = pancreatic_cancer_female_validation(age,b_chronicpan,b_type2,bmi,new_abdopain,new_appetiteloss,new_dysphagia,new_gibleed,new_indigestion,new_vte,new_weightloss,s1_bowelchange,smoke_cat,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double renal_tract_cancer_female_raw(
int age,double bmi,int c_hb,int new_abdopain,int new_appetiteloss,int new_haematuria,int new_indigestion,int new_pmb,int new_weightloss,int smoke_cat
)
{
	double survivor[0] = {
...
int age,double bmi,int c_hb,int new_abdopain,int new_appetiteloss,int new_haematuria,int new_indigestion,int new_pmb,int new_weightloss,int smoke_cat,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = renal_tract_cancer_female_validation(age,bmi,c_hb,new_abdopain,new_appetiteloss,new_haematuria,new_indigestion,new_pmb,new_weightloss,smoke_cat,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
...
static double uterine_cancer_female_raw(
int age,int b_endometrial,int b_type2,double bmi,int new_abdopain,int new_haematuria,int new_imb,int new_pmb,int new_vte
)
{
	double survivor[0] = {
...
int age,int b_endometrial,int b_type2,double bmi,int new_abdopain,int new_haematuria,int new_imb,int new_pmb,int new_vte,char *errorBuf,int errorBufSize
)
{
	int ok=1;
	*errorBuf=0;
...
{
	*error = 0;	int ok = uterine_cancer_female_validation(age,b_endometrial,b_type2,bmi,new_abdopain,new_haematuria,new_imb,new_pmb,new_vte,errorBuf,errorBufSize);
	if(!ok) { 
		*error = 1;
		return 0.0;
	}
