Welcome to bmiPredictor (http://svn.clinrisk.co.uk/opensource/bmiPredictor)
-------------------------------------------
...
To compile bmiPredictor on a UNIX-like system, type
 make
 make executables
to create the command line executables.

Please check http://svn.clinrisk.co.uk/opensource/bmiPredictor for our latest sources.
The bmiPredictor algorithms will be updated annually.  
